...
from util import func_calConfusionMatrix_sklearn,calConfustionMatrix
...
testX =   np.delete(X,randomTrainingSamples,axis = 0) # testing samples               
testY =   np.delete(y,randomTrainingSamples,axis=0)# labels of testing samples     nTest X 1
'''
####################PLACEHOLDER 1#end#########################
...
######################PLACEHOLDER 3 #end #########################
accuracy, precision, recall = func_calConfusionMatrix_sklearn(yHat.copy(), testY)
# step 4: evaluation
